...
When **reviewing recordings** in Friday, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Friday records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Friday recordings** - Use wired/speakers instead
...
### This is Not a Friday Bug

The issue is in **macOS's Bluetooth audio stack**, not in Friday's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Friday bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Friday now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: Friday v0.0.5+ on macOS
