...
Friday is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
To improve Friday and ensure optimal performance, we collect minimal, anonymized usage data:
...
*This privacy policy applies to Friday v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*
