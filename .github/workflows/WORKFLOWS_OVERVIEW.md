...
- Artifacts prefixed with `friday-test-`
...
```
friday-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `friday-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `friday-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `friday-macos-aarch64-release-0.1.3`
...
- `FRIDAY_RSA_PUBLIC_KEY` - License validation public key
