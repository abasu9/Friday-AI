...
if (-not $env:TAURI_SIGNING_PRIVATE_KEY) {
    ...
    Write-Host "     Get-Content .tauri\friday.key -Raw" -ForegroundColor Gray
    Write-Host ""
    ...
    Write-Host "     `$env:TAURI_SIGNING_PRIVATE_KEY = Get-Content .tauri\friday.key -Raw" -ForegroundColor Gray
