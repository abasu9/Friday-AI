...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/friday/meeting_minutes.db',  // Apple Silicon (M1/M2/M3)
  '/usr/local/var/friday/meeting_minutes.db',      // Intel Macs
];
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-blue-800 mb-2">
            We found an existing database from an earlier version of the app (Python backend version).
          </p>
