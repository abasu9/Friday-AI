  ...
  const handleBrowse = async () => {
    try {
      ...
      if (dbPath) {
        ...
        setErrorMessage('No database found at the selected location. Please select the legacy app folder, backend folder, or the database file directly.');
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Friday!</DialogTitle>
          <DialogDescription className="text-base pt-2">
            Do you have data from a previous version of the app?
          </DialogDescription>
        </DialogHeader>
