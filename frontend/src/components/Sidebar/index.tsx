          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${isMeetingPage ? 'bg-secondary' : 'hover:bg-secondary'
                  }`}
              >
      ...
      <div key={item.id}>
        <div
          className={`flex items-center transition-all duration-150 group ${item.type === 'folder' && depth === 0
            ...
            : `px-3 py-2 my-0.5 rounded-md text-sm ${isActive ? 'bg-secondary text-foreground font-medium' :
              hasTranscriptMatch ? 'bg-yellow-50' : 'hover:bg-secondary'
            } cursor-pointer`
            }`}
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-40">
      ...
      <button
        ...
        className="absolute -right-6 top-20 z-50 p-1 bg-card hover:bg-secondary text-foreground rounded-full shadow-lg border border-border"
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-border rounded-md bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
