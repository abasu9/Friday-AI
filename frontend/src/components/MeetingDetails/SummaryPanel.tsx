    ...
    <div className="flex-1 min-w-0 flex flex-col bg-background overflow-hidden">
      ...
      {isSummaryLoading ? (
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          {summaryResponse && (
            <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border shadow-lg p-4 max-h-1/3 overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-secondary p-4 rounded-lg shadow-sm mt-4">
