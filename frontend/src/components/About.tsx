...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://friday.ai' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto text-foreground">
            {/* Compact Header */}
            <div className="text-center">
                <div className="mb-3 rounded-3xl bg-background p-4">
                    <Image
                        src="/friday-logo.jpg"
                        alt="Friday Logo"
                        width={320}
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-foreground">What makes Friday different</h2>
