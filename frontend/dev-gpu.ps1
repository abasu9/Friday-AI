# GPU-accelerated development script for Friday (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Friday" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Friday in development mode..." -ForegroundColor Blue
Write-Host ""
