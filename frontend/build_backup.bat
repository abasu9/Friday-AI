@echo off
REM Friday Build Script for Windows
...
echo 🚀 Building Friday application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Friday Tauri application for Windows.
